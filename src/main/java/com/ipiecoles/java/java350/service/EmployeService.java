...
public class EmployeService {
    ...
    public void embaucheEmploye(String nom, String prenom, Poste poste, NiveauEtude niveauEtude, Double tempsPartiel) throws EmployeException, EntityExistsException {
        ...
        logger.info("Récupération d'un nouveau matricule pour l'employé {} {} en cours...", nom, prenom);
        ...
        //Calcul du salaire
        logger.info("Calcul du salaire de l'employé {} {} en cours...", nom, prenom);
        ...
        logger.info("Création de l'employé {} {} sauvegardé avec succès", nom, prenom);
    }
